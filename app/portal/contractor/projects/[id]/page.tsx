      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            {project.homeowner && (
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Client Information</h3>
                <p className="font-semibold text-gray-900">{project.homeowner.name}</p>
                <p className="text-sm text-gray-600">{project.homeowner.email}</p>
                {project.homeowner.phone && (
                  <p className="text-sm text-gray-600">{project.homeowner.phone}</p>
                )}
              </div>
            )}
          </div>
              ...
              {project.homeowner && (
                <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-teal-800">
                    <strong>Client:</strong> {project.homeowner.name} ({project.homeowner.email})
                  </p>
                </div>
              )}
            </div>
