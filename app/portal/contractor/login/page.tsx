              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-cyan-300 rounded-xl focus:ring-4 focus:ring-cyan-400 focus:border-cyan-500 bg-white shadow-md transition-all"
